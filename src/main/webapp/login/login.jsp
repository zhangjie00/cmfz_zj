    ...
    <script>
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${path}/admin/getCode?time=" + new Date().getTime());
            });
            ...
            $.extend($.validator.messages, {
                ...
                minlength: $.validator.format("<span style='color:red' >最少要输入3个字符</span>"),
            });
                        ...
                        success: function (data) {
                           // alert("进来了！");
                            if(data.status){
                                ...
                                //登录失败  展示错误信息
                                $("#msgDiv").html("<font color='red'>"+data.message+"<font>");
                            }
                        }
                    })
                }
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action=" " method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/admin/getCode">
